          ...
          <div>
            ...
            <div class="Rectangle-2">
               <select id= "Sexo" name="sexo">
                    <option id ="opciones"value=""selected hidden>Sexo</option> 
            ...
            <input class="Rectangle-2" placeholder="Número de celular">
            <input class="Rectangle-2" placeholder="Correo electrónico">
            <div class="captcha">
